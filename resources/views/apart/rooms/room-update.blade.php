            ...
            <div class="main-content app-content mt-0">
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <!-- Row -->
                        <div class="row">
                            <form method="post" action="{{route('apart.rooms.update',$room->id)}}" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                                                ...
                                                                <div class="col-xl-12 col-md-12">
                                                                    <div class="form-group m-0">
                                                                        <div class="custom-controls-stacked">
                                                                            ...
                                                                            <label class="custom-control custom-checkbox" style="width: fit-content; margin-bottom: 10px; display: inline-block; margin-right: 25px;">
                                                                                <input type="checkbox" class="custom-control-input" name="air_conditioning" id="air_conditioning" value="{{$room->air_conditioning}}" @if(!empty($room->air_conditioning)) checked @endif>
                                                                                <span class="custom-control-label">air_conditioning</span>
                                                                            </label>
                                                                            <label class="custom-control custom-checkbox" style="width: fit-content; margin-bottom: 10px; display: inline-block; margin-right: 25px;">
