                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Page Update</h1>
                        </div>
                        <!-- PAGE-HEADER END -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="card-body">
                                                            <ul id="lightgallery" class="list-unstyled row">
                                                                <li class="col-xs-6 col-sm-4 col-md-4 col-xl-3 mb-5 border-bottom-0" data-responsive="/public/{{$page->image}}" data-src="/public/{{$page->image}}">
                                                                    <a href="">
                                                                        <img class="img-responsive br-5" src="/public/{{$page->image}}">
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </div>
