...
class RoomsController extends Controller
{
    ...
    {
        return view('apart.rooms.room-add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $room_images = RoomsPicturesModel::where([["status","=","1"],["room_id","=",$room->id]])->orderBy('id','ASC')->get();

        return redirect()->route('apart.rooms.edit',[
            'add' => $add,
            $room->id => $room->id
        ])->with(compact('room_images'));
    }
    ...
    public function edit($id)
    {
        ...
        if($room->apart_id == $apart_id){
            return view('apart.rooms.room-update',compact([['room'],['room_pictures']]));
        }else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($room->apart_id == $apart_id){
            if(isset($request->save)){
                ...
                $oda = DB::table('room_images')->select('*')->where("room_id","=",$room->id)->get();
