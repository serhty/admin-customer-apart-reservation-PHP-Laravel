                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Edit reservation / @if($reservation->status == 1)Approved @elseif($reservation->status == 2) Waiting for approval @endif</h1>
                        </div>
                        <!-- PAGE-HEADER END -->
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6 mb-0">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="final_price" id="final_price" value="{{$reservation->final_price}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6 mb-0">
                                                    <div class="form-group">
                                            ...
                                            <div class="form-footer mt-2">
                                                ...
                                                <button class="btn btn-success" type="submit" name="onayla" value="onayla">Onayla</button>
                                                @endif
