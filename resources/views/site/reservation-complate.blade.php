...
@section('content')
    ...
    <div class="subheader normal-bg section-padding">
        <div class="container">
            <div class="row">
            <div class="col-12">
                <h1 class="text-custom-white">Reservation Request Received!</h1>
                        ...
                        <article class="post p-relative">
                            <div class="post-wrapper">
                                <div class="blog-meta bg-custom-white">
									...
									<p class="text-light-dark">We will contact you as soon as possible from your contact information!</p>
                                </div>
                            </div>
                        </article>
                    </div>
