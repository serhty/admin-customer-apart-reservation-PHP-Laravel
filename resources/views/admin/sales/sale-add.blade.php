                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Sale Add</h1>
                        </div>
                        <!-- PAGE-HEADER END -->
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12 mb-0">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="customer_apart" id="customer_apart">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-12 mb-0">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control mydatepicker" name="sale_date" id="sale_date">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12 mb-0">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="payable" id="payable">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
